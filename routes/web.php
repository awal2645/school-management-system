...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('pdf/generate', [PdfController::class, 'create'])->name('pdf.download');
    ...
    Route::get('/payment/view/list', [StudentPaymentController::class, 'getStudentPayment'])->name('payment.list.show');
    Route::post('/payment/view/list',[StudentPaymentController::class, 'paymnetStore'])->name('paymnet.store');
